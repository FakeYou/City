...
Grid.prototype.setNeighbor = function(node, neighbor) {
...
Node.prototype.reset = function(node) {
    var defaults = ['x', 'y', 'walkable', 'neighbors'];

    for(var variable in this) {
        if(defaults.indexOf(variable) == -1) {
 ...
 *     end positions.
 */
AStarFinder.prototype.findPath = function(startNode, endNode) {
